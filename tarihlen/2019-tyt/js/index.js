(function($) {
    ...
    var myColor;
    var all_questions = [{
        question_string: "Asya Hun Devleti’nin dağılmasının ardından Hunlar, batıya doğru yayılmaya başlamış ve Karadeniz'in kuzeyinde bulunan Germen kavimlerini batıya doğru itmişlerdir. Kavimler Göçü adı verilen bu süreçte Hunlar Avrupa siyasetinde etkin hâle gelirken ikiye ayrılan Roma İmparatorluğu önemli sorunlarla karşı karşıya kalmıştır.\nBuna göre aşağıdakilerden hangisi Kavimler Göçü’nün sonuçlarından biri olarak gösterilemez?",
        choices: {
            correct: "Bilim ve teknikte önemli gelişmeler yaşanmıştır.",
            wrong: ["Türk kültürü Avrupa’da yayılmıştır.", "Avrupa'nın etnik yapısı değişmiştir.", "Roma İmparatorluğu güç kaybetmeye başlamıştır.", "Avrupa’da siyasi dengeler değişmiştir."]
        }
    }, {
        question_string: "Gazneli Mahmut, Abbasi halifesini Büveyhoğullarının baskısından kurtarmış ve bu hizmetine karşılık olarak Abbasi halifesinden Sultan unvanını almıştır.\nBu bilgiyle aşağıdakilerden hangisine ulaşılabilir?",
        choices: {
            correct: "Gazneli Mahmut’un İslam dünyasının önemli bir siyasi gücü olduğuna",
            wrong: ["Abbasi halifesinin siyasi yetkilerini Gazneli Mahmut'a bıraktığına", "Türkler arasında İslamiyetin hızla yayıldığına", "İslam dünyasında mezhep çatışmalarının son bulduğuna", "Gazneli Mahmut’un İslam dünyasında siyasi birliği sağladığına"]
        }
    }, {
        question_string: "Tarih öğretmeni Nil'e ödev olarak Divanıhümayun konusunu vermiştir. Nil hazırladığı ödevde Divanıhümayunun görevlerinden beşini yazmış ancak öğretmeni bunlardan birinin yanlış olduğunu belirtmiştir.\nBuna göre öğretmenin, Nil'in ödevinde yanlış olduğunu belirttiği görev aşağıdakilerden hangisidir?",
        choices: {
            correct: "Veliahtın belirlenmesi",
            wrong: ["Şikâyetlerin dinlenmesi", "Savaşa ve barışa karar verilmesi ", "Önemli davaların görülmesi", "Elçilerin kabul edilmesi"]
        }
    }, {
        question_string: "Son Osmanlı Mebusan Meclisinden gelen üyelerden ve yeni seçilmiş mebuslardan oluşan Birinci TBMM, bir taraftan kurtuluş mücadelesi verirken diğer taraftan da bağımsız bir devletin temellerini atmıştır. Bu meclisteki vekiller farklı zümrelere ait, farklı meslek ve düşüncelere sahipti. Hükûmet üyelerini seçen Meclis; yasama, yürütme ve yargı yetkisini de kullanmaktaydı.\n Buna göre Birinci TBMM ile ilgili olarak aşağıdaki yargılardan hangisine varılamaz?",
        choices: {
            correct: "İnkılap çalışmalarına öncelik verdiğine",
            wrong: ["Olağanüstü koşullarda toplandığına", "Kuvvetler birliği ilkesini benimsediğine", "Meclis hükûmeti sisteminin uygulandığına", "Toplumdaki çeşitliliği yansıttığına"]
        }
    }, {
        question_string: "Atatürk, “Bize milliyetçi derler, fakat biz öyle bir milliyetçiyiz ki, bizimle iş birliği eden bütün milletlere hürmet ve riayet ederiz. Bizim milliyetçiliğimiz bencil ve mağrurane milliyetçilik değildir.” demiştir.\nBuna göre Atatürk milliyetçiliği,\nI. Başka milletlerin düşmanlığına dayanmaz.\nII. İnsan ve millet onuruna değer verir\nIII. Türk milletini üstün tutar.\nyargılarından hangilerini bünyesinde barındırır?",
        choices: {
            correct: "I ve II",
